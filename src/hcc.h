...
enum {
	...
	HCC_COMPOUND_DATA_TYPE_IDX_HCC_FRAGMENT_SV_OUT,
...
enum HccResourceDataType {
	...
	HCC_RESOURCE_DATA_TYPE_ANYBUFFER = 1,
	HCC_RESOURCE_DATA_TYPE_TEXTURE =   2,
	HCC_RESOURCE_DATA_TYPE_SAMPLER =   3,
...
#define HCC_RESOURCE_DATA_TYPE_IS_ANYBUFFER(type) (HCC_RESOURCE_DATA_TYPE_TYPE(type) == HCC_RESOURCE_DATA_TYPE_ANYBUFFER)
...
//
// initialization
#define HCC_RESOURCE_DATA_TYPE_ROANYBUFFER HCC_RESOURCE_DATA_TYPE_ANYBUFFER
#define HCC_RESOURCE_DATA_TYPE_RWANYBUFFER (HCC_RESOURCE_DATA_TYPE_ANYBUFFER | HCC_RESOURCE_DATA_TYPE_IS_RW_MASK)

#define HCC_RESOURCE_DATA_TYPE_BUFFER(idx, is_rw) \
( \
...
#define HCC_DATA_TYPE_IS_ANYBUFFER(type)     ((HCC_DATA_TYPE_TYPE(type) == HCC_DATA_TYPE_RESOURCE || HCC_DATA_TYPE_TYPE(type) == HCC_DATA_TYPE_RESOURCE_DESCRIPTOR) && HCC_RESOURCE_DATA_TYPE_IS_ANYBUFFER(HCC_DATA_TYPE_AUX(type)))
...
#define HCC_DATA_TYPE_HCC_FRAGMENT_SV        HCC_DATA_TYPE(STRUCT, HCC_COMPOUND_DATA_TYPE_IDX_HCC_FRAGMENT_SV)
#define HCC_DATA_TYPE_HCC_FRAGMENT_SV_OUT    HCC_DATA_TYPE(STRUCT, HCC_COMPOUND_DATA_TYPE_IDX_HCC_FRAGMENT_SV_OUT)
...
#define HCC_ATA_TOKEN_KEYWORDS_START HCC_ATA_TOKEN_KEYWORD_VOID
	...
	HCC_ATA_TOKEN_KEYWORD_ROANYBUFFER,
	...
	HCC_ATA_TOKEN_KEYWORD_RWANYBUFFER,
