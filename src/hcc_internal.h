...
struct HccCompoundDataType {
	...
	HccAMLScalarDataTypeMask  has_scalar_data_types_mask;
...
enum {
	HCC_TYPEDEF_IDX_UINT8_T,
	HCC_TYPEDEF_IDX_UINT16_T,
	HCC_TYPEDEF_IDX_UINT32_T,
	HCC_TYPEDEF_IDX_UINT64_T,
	HCC_TYPEDEF_IDX_UINTPTR_T,
	HCC_TYPEDEF_IDX_INT8_T,
	HCC_TYPEDEF_IDX_INT16_T,
	HCC_TYPEDEF_IDX_INT32_T,
	HCC_TYPEDEF_IDX_INT64_T,
	HCC_TYPEDEF_IDX_INTPTR_T,
	HCC_TYPEDEF_IDX_HALF_T,
	HCC_TYPEDEF_IDX_HCC_VERTEX_INPUT_T,
	HCC_TYPEDEF_IDX_HCC_FRAGMENT_INPUT_T,

	HCC_TYPEDEF_IDX_PSCALARX_T_START,
#define HCC_TYPEDEF_IDX_PSCALARX_T_END (HCC_TYPEDEF_IDX_PSCALARX_T_START + (HCC_AML_INTRINSIC_DATA_TYPE_COUNT))

	HCC_TYPEDEF_IDX_SCALARX_T_START = HCC_TYPEDEF_IDX_PSCALARX_T_END,
#define HCC_TYPEDEF_IDX_SCALARX_T_END (HCC_TYPEDEF_IDX_SCALARX_T_START + (HCC_AML_INTRINSIC_DATA_TYPE_COUNT))

	HCC_TYPEDEF_IDX_USER_START = HCC_TYPEDEF_IDX_SCALARX_T_END,
#define HCC_TYPEDEF_IDX_INTRINSICS_COUNT HCC_TYPEDEF_IDX_USER_START
};

enum {
#define HCC_STRUCT_DATA_TYPE_IDX_START HCC_COMPOUND_DATA_TYPE_IDX_HCC_VERTEX_INPUT
	HCC_COMPOUND_DATA_TYPE_IDX_HCC_VERTEX_INPUT,
	HCC_COMPOUND_DATA_TYPE_IDX_HCC_FRAGMENT_INPUT,
	HCC_COMPOUND_DATA_TYPE_IDX_HALF,

#define HCC_COMPOUND_DATA_TYPE_IDX_INTRINSICS_CHECKED_COUNT HCC_COMPOUND_DATA_TYPE_IDX_PSCALARX_START
...
#define HCC_STRUCT_DATA_TYPE_IDX_END HCC_COMPOUND_DATA_TYPE_IDX_PSCALARX_END

#define HCC_UNION_DATA_TYPE_IDX_START HCC_COMPOUND_DATA_TYPE_IDX_SCALARX_START
	HCC_COMPOUND_DATA_TYPE_IDX_SCALARX_START = HCC_STRUCT_DATA_TYPE_IDX_END,
#define HCC_COMPOUND_DATA_TYPE_IDX_SCALARX_END (HCC_COMPOUND_DATA_TYPE_IDX_SCALARX_START + (HCC_AML_INTRINSIC_DATA_TYPE_COUNT))
#define HCC_UNION_DATA_TYPE_IDX_END HCC_COMPOUND_DATA_TYPE_IDX_SCALARX_END

	HCC_COMPOUND_DATA_TYPE_IDX_USER_START = HCC_UNION_DATA_TYPE_IDX_END,
...
//
// these get turned into HCC_ERROR_CODE_UNSUPPORTED_INTRINSIC_TYPE_USED
// when the function is not dead code
typedef struct HccASTUnsupportedIntrinsicTypeUsed HccASTUnsupportedIntrinsicTypeUsed;
struct HccASTUnsupportedIntrinsicTypeUsed {
...
struct HccASTFunction {
	...
	uint32_t                  unsupported_intrinsic_types_first_id;
...
enum {
	HCC_FUNCTION_SCALARX_SWIZZLE,
	HCC_FUNCTION_SCALARX_PACK,
	HCC_FUNCTION_SCALARX_UNPACK,
	HCC_FUNCTION_SCALARX_ANY,
	HCC_FUNCTION_SCALARX_ALL,
	HCC_FUNCTION_SCALARX_ADD,
	HCC_FUNCTION_SCALARX_SUB,
	HCC_FUNCTION_SCALARX_MUL,
	HCC_FUNCTION_SCALARX_DIV,
	HCC_FUNCTION_SCALARX_MOD,
	HCC_FUNCTION_SCALARX_EQ,
	HCC_FUNCTION_SCALARX_NEQ,
	HCC_FUNCTION_SCALARX_LT,
	HCC_FUNCTION_SCALARX_LTEQ,
	HCC_FUNCTION_SCALARX_GT,
	HCC_FUNCTION_SCALARX_GTEQ,
	HCC_FUNCTION_SCALARX_NOT,
	HCC_FUNCTION_SCALARX_NEG,
	HCC_FUNCTION_SCALARX_BITNOT,
	HCC_FUNCTION_SCALARX_MIN,
	HCC_FUNCTION_SCALARX_MAX,
	HCC_FUNCTION_SCALARX_CLAMP,
	HCC_FUNCTION_SCALARX_SIGN,
	HCC_FUNCTION_SCALARX_ABS,
	HCC_FUNCTION_SCALARX_BITAND,
	HCC_FUNCTION_SCALARX_BITOR,
	HCC_FUNCTION_SCALARX_BITXOR,
	HCC_FUNCTION_SCALARX_BITSHL,
	HCC_FUNCTION_SCALARX_BITSHR,
	HCC_FUNCTION_SCALARX_FMA,
	HCC_FUNCTION_SCALARX_FLOOR,
	HCC_FUNCTION_SCALARX_CEIL,
	HCC_FUNCTION_SCALARX_ROUND,
	HCC_FUNCTION_SCALARX_TRUNC,
	HCC_FUNCTION_SCALARX_FRACT,
	HCC_FUNCTION_SCALARX_RADIANS,
	HCC_FUNCTION_SCALARX_DEGREES,
	HCC_FUNCTION_SCALARX_STEP,
	HCC_FUNCTION_SCALARX_SMOOTHSTEP,
	HCC_FUNCTION_SCALARX_BITSTO,
	HCC_FUNCTION_SCALARX_BITSFROM,
	HCC_FUNCTION_SCALARX_SIN,
	HCC_FUNCTION_SCALARX_COS,
	HCC_FUNCTION_SCALARX_TAN,
	HCC_FUNCTION_SCALARX_ASIN,
	HCC_FUNCTION_SCALARX_ACOS,
	HCC_FUNCTION_SCALARX_ATAN,
	HCC_FUNCTION_SCALARX_SINH,
	HCC_FUNCTION_SCALARX_COSH,
	HCC_FUNCTION_SCALARX_TANH,
	HCC_FUNCTION_SCALARX_ASINH,
	HCC_FUNCTION_SCALARX_ACOSH,
	HCC_FUNCTION_SCALARX_ATANH,
	HCC_FUNCTION_SCALARX_ATAN2,
	HCC_FUNCTION_SCALARX_POW,
	HCC_FUNCTION_SCALARX_EXP,
	HCC_FUNCTION_SCALARX_LOG,
	HCC_FUNCTION_SCALARX_EXP2,
	HCC_FUNCTION_SCALARX_LOG2,
	HCC_FUNCTION_SCALARX_SQRT,
	HCC_FUNCTION_SCALARX_RSQRT,
	HCC_FUNCTION_SCALARX_ISINF,
	HCC_FUNCTION_SCALARX_ISNAN,
	HCC_FUNCTION_SCALARX_LERP,
	HCC_FUNCTION_SCALARX_DOT,
	HCC_FUNCTION_SCALARX_LEN,
	HCC_FUNCTION_SCALARX_NORM,
	HCC_FUNCTION_SCALARX_REFLECT,
	HCC_FUNCTION_SCALARX_REFRACT,
	HCC_FUNCTION_SCALARX_MATRIX_MUL_SCALAR,
	HCC_FUNCTION_SCALARX_MATRIX_MUL_VECTOR,
	HCC_FUNCTION_SCALARX_MATRIX_TRANSPOSE,
	HCC_FUNCTION_SCALARX_MATRIX_OUTER_PRODUCT,
	HCC_FUNCTION_SCALARX_MATRIX_DETERMINANT,
	HCC_FUNCTION_SCALARX_MATRIX_INVERSE,

	HCC_FUNCTION_SCALARX_COUNT,
};
...
#define HCC_FUNCTION_IDX_SPECIFIC_END HCC_FUNCTION_IDX_SCALARX_START

	HCC_FUNCTION_IDX_SCALARX_START,
#define HCC_FUNCTION_IDX_SCALARX_END (HCC_FUNCTION_IDX_SCALARX_START + HCC_FUNCTION_SCALARX_COUNT * HCC_AML_INTRINSIC_DATA_TYPE_COUNT)

	HCC_FUNCTION_IDX_USER_START = HCC_FUNCTION_IDX_SCALARX_END,
...
extern const char* hcc_function_scalarx_strings[HCC_FUNCTION_SCALARX_COUNT];
extern const char* hcc_intrinsic_function_specific_strings[HCC_FUNCTION_IDX_SPECIFIC_END];
...
typedef uint32_t HccDeclEntryValue;
#define HCC_DECL_ENTRY_VALUE(decl, has_concrete_impl) (((decl) & 0x7fffffff) | ((has_concrete_impl) << 31))
#define HCC_DECL_ENTRY_VALUE_DECL(value) ((value) & 0x7fffffff)
#define HCC_DECL_ENTRY_VALUE_HAS_CONCRETE_IMPL(value) ((value) >> 31)

typedef struct HccDeclEntry HccDeclEntry;
struct HccDeclEntry {
	HccStringId       string_id;
	HccDeclEntryValue value;
	HccLocation*      location;
};
...
enum {
	...
	HCC_ASTGEN_SPECIFIER_INTRINSIC,
...
enum {
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_INTRINSIC =           1 << HCC_ASTGEN_SPECIFIER_INTRINSIC,
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_VARIABLE_SPECIFIERS = HCC_ASTGEN_SPECIFIER_FLAGS_STATIC,
	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_FUNCTION_SPECIFIERS =
		HCC_ASTGEN_SPECIFIER_FLAGS_INTRINSIC |
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_TYPEDEF_SPECIFIER = HCC_ASTGEN_SPECIFIER_FLAGS_INTRINSIC,
...
enum {
	...
	HCC_ASTGEN_TYPE_SPECIFIER_GENERIC_FLOAT = 0x8000,
	...
	HCC_ASTGEN_TYPE_SPECIFIER_FLOAT_TYPES =
		HCC_ASTGEN_TYPE_SPECIFIER_FLOAT        |
		HCC_ASTGEN_TYPE_SPECIFIER_DOUBLE       |
		HCC_ASTGEN_TYPE_SPECIFIER_GENERIC_FLOAT,
...
struct HccASTGen {
	...
	HccStack(uint32_t)         variable_stack_var_indices;
...
#define HCC_STRING_ID_INTRINSICS_START HCC_STRING_ID_INTRINSIC_TYPEDEFS_START

	HCC_STRING_ID_INTRINSIC_TYPEDEFS_START,
#define HCC_STRING_ID_INTRINSIC_TYPEDEFS_END (HCC_STRING_ID_INTRINSIC_TYPEDEFS_START + HCC_TYPEDEF_IDX_INTRINSICS_COUNT)

	HCC_STRING_ID_INTRINSIC_COMPOUND_DATA_TYPES_START = HCC_STRING_ID_INTRINSIC_TYPEDEFS_END,
#define HCC_STRING_ID_INTRINSIC_COMPOUND_DATA_TYPES_END (HCC_STRING_ID_INTRINSIC_COMPOUND_DATA_TYPES_START + HCC_COMPOUND_DATA_TYPE_IDX_INTRINSICS_COUNT)
	...
	HCC_STRING_ID_VERTEX_IDX = HCC_STRING_ID_INTRINSIC_COMPOUND_DATA_TYPES_END,
	HCC_STRING_ID_INSTANCE_IDX,
	HCC_STRING_ID_FRAG_COORD,
	HCC_STRING_ID__BITS,

#define HCC_STRING_ID_INTRINSICS_END (HCC_STRING_ID__BITS + 1)
...
#define HCC_STRING_ID_PREDEFINED_MACROS_END (HCC_STRING_ID_PREDEFINED_MACROS_START + HCC_PP_PREDEFINED_MACRO_COUNT)
	...
	HCC_STRING_ID_INTRINSIC_FUNCTIONS_START = HCC_STRING_ID_PREDEFINED_MACROS_END,
#define HCC_STRING_ID_INTRINSIC_FUNCTIONS_END (HCC_STRING_ID_INTRINSIC_FUNCTIONS_START + HCC_FUNCTION_IDX_INTRINSICS_COUNT)

	HCC_STRING_ID_ONCE = HCC_STRING_ID_INTRINSIC_FUNCTIONS_END,
	HCC_STRING_ID_DEFINED,
	HCC_STRING_ID___VA_ARGS__,
};

extern const char* hcc_string_intrinsics[HCC_STRING_ID_INTRINSICS_END];
