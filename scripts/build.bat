...
IF "%~1" == "release" (
  ...
  cd build
  powershell Compress-Archive -Force -DestinationPath hcc-0.2.0-windows.zip -LiteralPath hcc.exe, hcc.pdb, ..\libc, ..\libhmaths, ..\libhccintrinsics, ..\interop, ..\samples, ..\playground, ..\docs, ..\README.md, ..\LICENSE
  cd ..
)
